...
INSERT INTO hangar_project (slug, owner, name, description, created_at, last_updated, downloads, visibility, avatar_url, version_name, source_url, source_repository_host, source_repository_owner, source_repository_name)
  VALUES (:slug, :owner, :name, :description, :created_at, :last_updated, :downloads, :visibility, :avatar_url, :version_name, :source_url, :source_repository_host, :source_repository_owner, :source_repository_name)
  ON CONFLICT (slug)
  DO UPDATE SET
