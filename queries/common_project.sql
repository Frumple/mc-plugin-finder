...
INSERT INTO common_project (id, release_date, update_date, spigot_id, spigot_name, spigot_author, spigot_tag, hangar_slug, hangar_name, hangar_owner, hangar_description)
  VALUES (COALESCE(:id, nextval('common_project_id_seq')), :release_date, :update_date, :spigot_id, :spigot_name, :spigot_author, :spigot_tag, :hangar_slug, :hangar_name, :hangar_owner, :hangar_description)
  ON CONFLICT (id)
  DO UPDATE SET
