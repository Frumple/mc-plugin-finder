...
} }pub fn get_latest_update_date() -> GetLatestUpdateDateStmt
{ GetLatestUpdateDateStmt(cornucopia_async :: private :: Stmt :: new("SELECT max(update_date) from spigot_resource")) } pub
struct GetLatestUpdateDateStmt(cornucopia_async :: private :: Stmt) ; impl
GetLatestUpdateDateStmt { pub fn bind < 'a, C : GenericClient, >
(& 'a mut self, client : & 'a  C,
