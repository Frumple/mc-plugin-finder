...
}pub fn get_merged_common_projects() -> GetMergedProjectsStmt
...
GetMergedProjectsStmt(cornucopia_async::private::Stmt); impl GetMergedProjectsStmt
{ pub fn bind<'a, C:
...
CommonProjectEntity, 0>
{
    CommonProjectEntityQuery
    {
        ...
        |row| { CommonProjectEntityBorrowed { id: row.get(0),release_date: row.get(1),update_date: row.get(2),spigot_id: row.get(3),spigot_name: row.get(4),spigot_author: row.get(5),spigot_tag: row.get(6),hangar_slug: row.get(7),hangar_name: row.get(8),hangar_owner: row.get(9),hangar_description: row.get(10),} }, mapper: |it| { <CommonProjectEntity>::from(it) },
    }
} }pub fn upsert_common_project() -> UpsertCommonProjectStmt
{ UpsertCommonProjectStmt(cornucopia_async::private::Stmt::new("INSERT INTO common_project (id, release_date, update_date, spigot_id, spigot_name, spigot_author, spigot_tag, hangar_slug, hangar_name, hangar_owner, hangar_description)
...
tokio_postgres::Error>> + Send + 'a>>, C> for UpsertCommonProjectStmt
{
    ...
    { Box::pin(self.bind(client, &params.id,&params.release_date,&params.update_date,&params.spigot_id,&params.spigot_name,&params.spigot_author,&params.spigot_tag,&params.hangar_slug,&params.hangar_name,&params.hangar_owner,&params.hangar_description,)) }
...
{ pub slug : String,pub owner : String,pub name : String,pub description : String,pub created_at : time::OffsetDateTime,pub last_updated : time::OffsetDateTime,pub visibility : String,pub avatar_url : String,pub version : String,pub source_code_link : Option<String>,pub source_repository_host : Option<String>,pub source_repository_owner : Option<String>,pub source_repository_name : Option<String>,}pub struct HangarProjectEntityBorrowed<'a> { pub slug : &'a str,pub owner : &'a str,pub name : &'a str,pub description : &'a str,pub created_at : time::OffsetDateTime,pub last_updated : time::OffsetDateTime,pub visibility : &'a str,pub avatar_url : &'a str,pub version : &'a str,pub source_code_link : Option<&'a str>,pub source_repository_host : Option<&'a str>,pub source_repository_owner : Option<&'a str>,pub source_repository_name : Option<&'a str>,}
impl<'a> From<HangarProjectEntityBorrowed<'a>> for HangarProjectEntity
{
    fn from(HangarProjectEntityBorrowed { slug,owner,name,description,created_at,last_updated,visibility,avatar_url,version,source_code_link,source_repository_host,source_repository_owner,source_repository_name,}: HangarProjectEntityBorrowed<'a>) ->
...
tokio_postgres::Error>> + Send + 'a>>, C> for UpsertHangarProjectStmt
{
    ...
    tokio_postgres::Error>> + Send + 'a>>
    { Box::pin(self.bind(client, &params.slug,&params.owner,&params.name,&params.description,&params.created_at,&params.last_updated,&params.visibility,&params.avatar_url,&params.version,&params.source_code_link,&params.source_repository_host,&params.source_repository_owner,&params.source_repository_name,)) }
...
{ pub id : i32,pub name : String,pub parsed_name : Option<String>,pub tag : String,pub slug : String,pub release_date : time::OffsetDateTime,pub update_date : time::OffsetDateTime,pub author_id : i32,pub version_id : i32,pub version_name : Option<String>,pub premium : Option<bool>,pub source_code_link : Option<String>,pub source_repository_host : Option<String>,pub source_repository_owner : Option<String>,pub source_repository_name : Option<String>,}pub struct SpigotResourceEntityBorrowed<'a> { pub id : i32,pub name : &'a str,pub parsed_name : Option<&'a str>,pub tag : &'a str,pub slug : &'a str,pub release_date : time::OffsetDateTime,pub update_date : time::OffsetDateTime,pub author_id : i32,pub version_id : i32,pub version_name : Option<&'a str>,pub premium : Option<bool>,pub source_code_link : Option<&'a str>,pub source_repository_host : Option<&'a str>,pub source_repository_owner : Option<&'a str>,pub source_repository_name : Option<&'a str>,}
impl<'a> From<SpigotResourceEntityBorrowed<'a>> for SpigotResourceEntity
{
    fn from(SpigotResourceEntityBorrowed { id,name,parsed_name,tag,slug,release_date,update_date,author_id,version_id,version_name,premium,source_code_link,source_repository_host,source_repository_owner,source_repository_name,}: SpigotResourceEntityBorrowed<'a>) ->
