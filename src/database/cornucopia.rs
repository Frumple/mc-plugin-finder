...
CommonProjectEntity, 0>
{
    CommonProjectEntityQuery
    {
        ...
        |row| { CommonProjectEntityBorrowed { spigot_id: row.get(0),spigot_slug: row.get(1),spigot_name: row.get(2),spigot_description: row.get(3),spigot_author: row.get(4),spigot_version: row.get(5),spigot_premium: row.get(6),spigot_abandoned: row.get(7),spigot_icon_data: row.get(8),spigot_date_created: row.get(9),spigot_date_updated: row.get(10),spigot_latest_minecraft_version: row.get(11),spigot_downloads: row.get(12),spigot_likes: row.get(13),modrinth_id: row.get(14),modrinth_slug: row.get(15),modrinth_name: row.get(16),modrinth_description: row.get(17),modrinth_author: row.get(18),modrinth_version: row.get(19),modrinth_icon_url: row.get(20),modrinth_date_created: row.get(21),modrinth_date_updated: row.get(22),modrinth_latest_minecraft_version: row.get(23),modrinth_downloads: row.get(24),modrinth_follows: row.get(25),hangar_slug: row.get(26),hangar_name: row.get(27),hangar_description: row.get(28),hangar_author: row.get(29),hangar_version: row.get(30),hangar_avatar_url: row.get(31),hangar_date_created: row.get(32),hangar_date_updated: row.get(33),hangar_latest_minecraft_version: row.get(34),hangar_downloads: row.get(35),hangar_stars: row.get(36),hangar_watchers: row.get(37),source_repository_host: row.get(38),source_repository_name: row.get(39),source_repository_owner: row.get(40),} }, mapper: |it| { <CommonProjectEntity>::from(it) },
    }
...
{ pub full_count : i64,pub date_created : time::OffsetDateTime,pub date_updated : time::OffsetDateTime,pub latest_minecraft_version : Option<String>,pub downloads : i32,pub likes_and_stars : i32,pub follows_and_watchers : i32,pub spigot_id : Option<i32>,pub spigot_slug : Option<String>,pub spigot_name : Option<String>,pub spigot_description : Option<String>,pub spigot_author : Option<String>,pub spigot_version : Option<String>,pub spigot_premium : Option<bool>,pub spigot_abandoned : Option<bool>,pub spigot_icon_data : Option<String>,pub modrinth_id : Option<String>,pub modrinth_slug : Option<String>,pub modrinth_name : Option<String>,pub modrinth_description : Option<String>,pub modrinth_author : Option<String>,pub modrinth_version : Option<String>,pub modrinth_icon_url : Option<String>,pub hangar_slug : Option<String>,pub hangar_name : Option<String>,pub hangar_description : Option<String>,pub hangar_author : Option<String>,pub hangar_version : Option<String>,pub hangar_avatar_url : Option<String>,pub source_repository_host : Option<String>,pub source_repository_owner : Option<String>,pub source_repository_name : Option<String>,}pub struct SearchResultEntityBorrowed<'a> { pub full_count : i64,pub date_created : time::OffsetDateTime,pub date_updated : time::OffsetDateTime,pub latest_minecraft_version : Option<&'a str>,pub downloads : i32,pub likes_and_stars : i32,pub follows_and_watchers : i32,pub spigot_id : Option<i32>,pub spigot_slug : Option<&'a str>,pub spigot_name : Option<&'a str>,pub spigot_description : Option<&'a str>,pub spigot_author : Option<&'a str>,pub spigot_version : Option<&'a str>,pub spigot_premium : Option<bool>,pub spigot_abandoned : Option<bool>,pub spigot_icon_data : Option<&'a str>,pub modrinth_id : Option<&'a str>,pub modrinth_slug : Option<&'a str>,pub modrinth_name : Option<&'a str>,pub modrinth_description : Option<&'a str>,pub modrinth_author : Option<&'a str>,pub modrinth_version : Option<&'a str>,pub modrinth_icon_url : Option<&'a str>,pub hangar_slug : Option<&'a str>,pub hangar_name : Option<&'a str>,pub hangar_description : Option<&'a str>,pub hangar_author : Option<&'a str>,pub hangar_version : Option<&'a str>,pub hangar_avatar_url : Option<&'a str>,pub source_repository_host : Option<&'a str>,pub source_repository_owner : Option<&'a str>,pub source_repository_name : Option<&'a str>,}
impl<'a> From<SearchResultEntityBorrowed<'a>> for SearchResultEntity
{
    ...
    Self { Self { full_count,date_created,date_updated,latest_minecraft_version: latest_minecraft_version.map(|v| v.into()),downloads,likes_and_stars,follows_and_watchers,spigot_id,spigot_slug: spigot_slug.map(|v| v.into()),spigot_name: spigot_name.map(|v| v.into()),spigot_description: spigot_description.map(|v| v.into()),spigot_author: spigot_author.map(|v| v.into()),spigot_version: spigot_version.map(|v| v.into()),spigot_premium,spigot_abandoned,spigot_icon_data: spigot_icon_data.map(|v| v.into()),modrinth_id: modrinth_id.map(|v| v.into()),modrinth_slug: modrinth_slug.map(|v| v.into()),modrinth_name: modrinth_name.map(|v| v.into()),modrinth_description: modrinth_description.map(|v| v.into()),modrinth_author: modrinth_author.map(|v| v.into()),modrinth_version: modrinth_version.map(|v| v.into()),modrinth_icon_url: modrinth_icon_url.map(|v| v.into()),hangar_slug: hangar_slug.map(|v| v.into()),hangar_name: hangar_name.map(|v| v.into()),hangar_description: hangar_description.map(|v| v.into()),hangar_author: hangar_author.map(|v| v.into()),hangar_version: hangar_version.map(|v| v.into()),hangar_avatar_url: hangar_avatar_url.map(|v| v.into()),source_repository_host: source_repository_host.map(|v| v.into()),source_repository_owner: source_repository_owner.map(|v| v.into()),source_repository_name: source_repository_name.map(|v| v.into()),} }
...
{
    fn from(SpigotResourceEntityBorrowed { id,name,parsed_name,description,slug,date_created,date_updated,latest_minecraft_version,downloads,likes,author_id,version_id,version_name,premium,abandoned,icon_url,icon_data,source_url,source_repository_host,source_repository_owner,source_repository_name,}: SpigotResourceEntityBorrowed<'a>) ->
